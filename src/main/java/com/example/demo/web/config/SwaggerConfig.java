...
public class SwaggerConfig {
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfo("Spring Boot REST API", "Spring Boot REST API for Food", "1.0",
				"Terms of service", new Contact("Addison", "https://addison/about/", "addison.lu@sicmsb.com"),
